...
//    When used in GridBagLayout the original class casts the text area of the field as a component and the image fills only behind the text
// for other perpeses remove getParent method
    Insets insets = ((Container) c).getParent().getInsets();
    x = insets.left;
    y = insets.top;
